...
class PS4A: UITableViewController, NSXMLParserDelegate {
    ...
    override func viewDidLoad() {
        ...
        let urlPath: String = "http://feeds.ign.com/IGNPS4Articles"
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        let vc = segue.destinationViewController as ShowPS4AA
