...
class MovieAController: UITableViewController, NSXMLParserDelegate {
    ...
    override func viewDidLoad() {
        ...
        let urlPath: String = "http://feeds.ign.com/ign/tech-videos"
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        let vc = segue.destinationViewController as ShowMovieAController
