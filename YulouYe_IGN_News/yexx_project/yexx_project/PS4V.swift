...
class PS4V: UITableViewController, NSXMLParserDelegate {
    ...
    override func viewDidLoad() {
        ...
        let urlPath: String = "http://feeds.ign.com/IGNPS4Videos"
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        let vc = segue.destinationViewController as ShowPS4VV
