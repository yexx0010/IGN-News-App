...
class E3: UITableViewController, NSXMLParserDelegate {
    ...
    override func viewDidLoad() {
        ...
        let urlPath: String = "http://feeds.ign.com/ign/e3-articles"
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        let vc = segue.destinationViewController as ShowE3
