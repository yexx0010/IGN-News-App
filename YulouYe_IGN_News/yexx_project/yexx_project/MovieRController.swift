...
class MovieRController: UITableViewController, NSXMLParserDelegate {
    ...
    override func viewDidLoad() {
        ...
        let urlPath: String = "http://feeds.ign.com/ign/movies-reviews"
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        let vc = segue.destinationViewController as ShowMovieRController
